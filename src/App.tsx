        ...
        <section className="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden p-5 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            ...
            <div>
              ...
              <input type="text" value={landlordName} onChange={e => setLandlordName(e.target.value)} disabled={!!selectedPropertyId} className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm disabled:opacity-70" />
            </div>
            <div>
              <label className="block text-xs font-medium text-slate-500 mb-1">Landlord Phone</label>
              <input type="text" value={landlordPhone} onChange={e => setLandlordPhone(e.target.value)} disabled={!!selectedPropertyId} className="w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm disabled:opacity-70" />
            </div>
          </div>
        </section>
